...
<!-- home-one.html  13:01:10 GMT -->

<head>
    <title> Portfolio - Pedro Navarro </title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body class="dark-vertion black-bg">
                ...
                <nav class="navbar navbar-expand-lg mh-nav nav-btn">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-0 ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#mh-about">Acerca de</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#mh-pricing">Precios</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row xs-column-reverse section-separator vertical-middle-content home-padding">
                    <div class="col-sm-6">
                        <div class="mh-header-info">
                            ...
                            <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Ing. Pedro Navarro</h2>
                            <h4 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">Programador Web, Full Stack</h4>

                            <ul>
                                <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fa fa-envelope"></i><a href="mailto:">acevedo.navarro93@gmail.com</a></li>
                                <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s"><i class="fa fa-phone"></i><a href="callto:">+503 7216-8590</a></li>
                                <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s"><i class="fa fa-map-marker"></i>
                                    <address>14, San Miguel, El Salvador</address>
                                </li>
                            </ul>
                    ...
                    <div class="col-sm-6">
                        <div class="hero-img wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                            <div class="img-border">
                                <img src="assets/images/pedro.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row section-separator">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="mh-about-inner">
                        <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.1s">Acerca de mi</h2>
                        <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
                            Soy ingeniero en sistemas informáticos, tengo ya mas de tres años de experiencia como programador full stack,
                            en el backend uso PHP, en el frontend javascript, html5, css3, jquery, Bootstrap etc. en bases de datos MySql y SQL Server.
                        </p>
                        ...
                        <a href="#" class="btn btn-fill wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">Descargar CV <i class="fa fa-download"></i></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="mh-professional-skills wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
                        ...
                        <ul class="mh-professional-progress">
                            <li>
                                ...
                                <div class="pr-skill-name">Comunicacion</div>
                            </li>
                            <li>
    ...
    <section class="mh-portfolio" id="mh-portfolio">
        <div class="container">
            ...
            <!-- MODAL DONDE SE MUESTRA LA INFORMACION DE LOS PROYECTOS
         -->
